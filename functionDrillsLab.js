...
*/
const exclaimThree = (str) => str.toUpperCase("Let") + "!!!";
...
//CODE HERE
const bestMovie = (anyMovie) => `${anyMovie} is the best movie ever`;
let theBest = bestMovie("Avengers");
console.log(theBest);
...
//CODE HERE
const theEliminator = (competitors, died) => {
  for (let i = 0; i < competitors.length; i++) {
    if (competitors[i] === died) {
...
console.log(emailCheck("jamespangmail.com"));
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
const chocFrogs2 = (gold) => {
  return Math.floor(gold / 3);
};
console.log(chocFrogs2(13));
...
console.log(ascendingArray(sampleArray));
////////////////// PROBLEM 22 ////////////////////
